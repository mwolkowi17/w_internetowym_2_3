...
export class SceneMain1 extends Scene {
  ...
  create() {
    ...
    this.ikona_szansa1 = this.add.image(1560, 424, "zycie1").setAlpha(1);
    this.ikona_szansa2 = this.add.image(1660, 424, "zycie1").setAlpha(1);
    this.ikona_szansa3 = this.add.image(1760, 424, "zycie1").setAlpha(1);
    ...
    const rzut_kostka = () => {
      ...
      const wywolanie_sceny_koncowej = () => {
        ...
        this.scene.start("GameLevelOneEnd");
      };
    };

    // event przycisku rzut_kostka
    ...
    this.scene.get("GameQuizz").events.on("powrot-do-gry1", () => {
    ...
    this.scene.get("GameQuizz").events.on("odpowiedz-zla", () => {
